...
namespace Queue.Services.Media
{
    ...
    {
        public MediaServiceHost(DuplexChannelBuilder<IServerService> channelBuilder, Administrator currentUser, string folder, Type serviceType, params Uri[] baseAddresses)
