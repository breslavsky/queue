...
{
    public partial class SelectServiceUserControl : UserControl
    {
        ...
        private readonly SelectServiceViewModel model;

        private ObjectsPager pager;

        public SelectServiceUserControl()
        {
            InitializeComponent();

            if (!DesignerProperties.GetIsInDesignMode(this))
            {
                model = new SelectServiceViewModel();
